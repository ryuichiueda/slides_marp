...
- 次の尤度を最大化するものが「一番尤もらしい」と考える
    ...
    - 具体的に書くと
        - $\max_{\boldsymbol{\mu}_{1:n}, \Sigma_{1:n}, \pi_{1:n}} L(\boldsymbol{\mu}_{1:n}, \Sigma_{1:n}, \pi_{1:n}|\boldsymbol{x}_{1:N})= \prod_{j=1}^N  \sum_{i=1}^n \pi_i \mathcal{N}(\boldsymbol{x}_j | \boldsymbol{\mu}_i, \Sigma_i)$
