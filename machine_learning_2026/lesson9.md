...
- 下の例: 拡散過程
    - 各画素に対し、同じガウス分布に従う雑音を繰り返し足したもの
    - 最終的な画像（雑音だらけ）はガウス分布に従う
...
- 先ほど用いた拡散過程: 同じガウス分布を$T$回適用
    - 少しずつの雑音であれば、$T$回、同じノイズ除去の処理を繰り返すと元に戻すことができる（時間を巻き戻すことができる）
        - 非平衡熱力学の知見から
- DDPM
    - <span style="color:red">「1回分のノイズの除去処理」をANNに学習させる</span>
