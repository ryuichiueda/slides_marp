...
- データ$x_1, x_2, x_3, \dots$が互いに同じ分布から発生しており、かつ互いに影響を与えていないこと
    - 「互いに影響を与える」の例: $x_1$が大きい値だと$x_2$の値も大きい、など
...
- センサによって様々な悪影響
    - 例: センサの前を人や別のロボットが横切ると・・・
        ...
        - カメラ: 物が欠けて小さく見える
            - <span style="color:red">物体の大きさで距離を計測していると遠く見える$\leftarrow$これを実装</span>　
