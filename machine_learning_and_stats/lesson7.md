...
- 「損失関数の最小化」は機械学習のほぼすべての手法で共通の考え方
    ...
    - 最小2乗法: 学習のまえに数式で最適なパラメータが分かるので学習が不要なだけ


---

- 最小二乗法も人工ニューラルネットワークも他の機械学種の手法も制御も結局やってることは、ひとつの値を最小化するということ
    （「最大化」の場合は符号を変えると最小化になる）
- 何かふたつ以上のことを追い求める場合も、足し算等でひとつの値にしないと方針が定まらない

<center>ということで、これからも出てきます。</center>
