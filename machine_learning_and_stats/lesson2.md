...
- 2が出ていて、かつ偶数（回りくどいけど乗法定理で解いてみましょう）
...
- 数ゲームで各個人の能力が測れるか
- 特にBさんの210点をどう扱うか
- Cさんの42点は？（これは何か理由がありそうだけど書かれてない）
 $\rightarrow$このへんの話は次回以降
<br />
- お金だけで大会の価値が決まるのか？
    - （反論）じゃあお金以外の価値で選考すると恣意的にならないのか？
    - お金で決まるとしても優勝後に副収入がある場合もあるので賞金だけでは決まらない？
    $\rightarrow$ここらへんは政治に任せたほうがよさそう（政治がなくならない理由）
